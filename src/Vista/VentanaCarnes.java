...
import Modelo.CarnesBean;
import Modelo.ConsultarCarnes;
import Modelo.CarnesDAO;
import Modelo.RSButtonMetro;
import java.awt.Color;

public final class VentanaCarnes extends JFrame implements ActionListener,MouseListener, KeyListener {
    public JComboBox<String> ComboBoxSub;
    public JLabel Fondo;
    public JLabel Imagen;
    public JTable TablaCarnes;
    ...
    public VentanaCarnes() {
        ...
        TablaCarnes.setRowSorter(trsFiltro);
        
        objCarnesDAO=new CarnesDAO(this);
        
         Image icon = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Iconos/Carnes.png"));
        setIconImage(icon);
         setVisible(true);
    ...
    public void initComponents() {
       ...
       ComboBoxSub.addItemListener(new java.awt.event.ItemListener() {
        ...
        jLabel3.setText("                                        Carnes y Pescados");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(250, 30, 660, 40);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/Banner5.png"))); // NOI18N
        jPanel1.add(jLabel2);
        jLabel2.setBounds(340, 0, 480, 110);
        
        iconcat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/pescados.png"))); // NOI18N
        jLabel2.add(iconcat);
        iconcat.setBounds(50, 23, 75, 75);
        
        Fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/FondoCarnes.jpg"))); // NOI18N
        ...
        pack();
                ...
                ComboBoxSub.addItem(" ");
                ComboBoxSub.addItem("Atun");
                ComboBoxSub.addItem("Bonito");
                ComboBoxSub.addItem("Conservas");
                ComboBoxSub.addItem("Hamburguesa");
                ComboBoxSub.addItem("Hot Dog");
                ComboBoxSub.addItem("Jamonada");
                ComboBoxSub.addItem("Mariscos");
                ComboBoxSub.addItem("Nuggest");
                ComboBoxSub.addItem("Pechuga");
                ComboBoxSub.addItem("Trucha");
                
                
                   
                TablaCarnes.addMouseListener(this);
    ...
    public void borrarDato(){
        objCarnesDAO.BorrarDato();
    }
    
    public void vaciarDato(){
        objCarnesDAO.VaciarDato();
    }
    
    
    public void seleccionar(){
        try{
            objCarnesDAO.Seleccionar();
        }catch (Exception e){}  
    }
    ...
    public void LimpiarCampos(){
        objCarnesDAO.LimpiarCampos();
    }
    
    public void actualizarDatos(){
        objCarnesDAO.ActualizarDatos();
    }
    ...
    public static void main(String args[]) throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
        ...
        try {
            ...
            new VentanaCarnes().setVisible(true);
    }
