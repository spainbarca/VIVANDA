...
import Modelo.LacteosBean;
import Modelo.ConsultarLacteos;
import Modelo.LacteosDAO;
import Modelo.RSButtonMetro;
import java.awt.Color;

public final class VentanaLacteos extends JFrame implements ActionListener,MouseListener, KeyListener {
    public JComboBox<String> ComboBoxSub;
    public JLabel Fondo;
    public JLabel Imagen;
    public JTable TablaLacteos;
    ...
    public VentanaLacteos() {
        ...
        objConsultarLacteos = new ConsultarLacteos();
        ...
        TablaLacteos.setRowSorter(trsFiltro);
        
        objLacteosDAO=new LacteosDAO(this);
        
         Image icon = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Iconos/Lacteos.png"));
        setIconImage(icon);
         setVisible(true);
    ...
    public void initComponents() {
       ...
       ComboBoxSub.addItemListener(new java.awt.event.ItemListener() {
        ...
        iconcat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/Lacteo.png"))); // NOI18N
        jLabel2.add(iconcat);
        iconcat.setBounds(46, 18, 80, 80);
        
        Fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/FondoLacteos.jpg"))); // NOI18N
        ...
        pack();
                ...
                ComboBoxSub.addItem(" ");
                ComboBoxSub.addItem("Dulces Lácteos");
                ComboBoxSub.addItem("Helados");
                ComboBoxSub.addItem("Leche");
                ComboBoxSub.addItem("Mantequilla");
                ComboBoxSub.addItem("Queso");
                ComboBoxSub.addItem("Yogurt");
                TablaLacteos.addMouseListener(this);
    ...
    public void Listar(){
        try {
            objLacteosDAO.Listar();
        }catch (Exception e){
        } 
    }
    
    public void borrarDato(){
        objLacteosDAO.BorrarDato();
    }
    
    public void vaciarDato(){
        objLacteosDAO.VaciarDato();
    }
    
    
    public void seleccionar(){
        try{
            objLacteosDAO.Seleccionar();
        }catch (Exception e){}  
    }
    ...
    public void LimpiarCampos(){
        objLacteosDAO.LimpiarCampos();
    }
    
    public void actualizarDatos(){
        objLacteosDAO.ActualizarDatos();
    }
