...
import Modelo.GolosinaBean;
import Modelo.ConsultarGolosina;
import Modelo.GolosinaDAO;
import Modelo.RSButtonMetro;
import java.awt.Color;

public final class VentanaGolosina extends JFrame implements ActionListener,MouseListener, KeyListener {
    public JComboBox<String> ComboBoxSub;
    public JLabel Fondo;
    public JLabel Imagen;
    public JTable TablaGolosina;
    ...
    GolosinaDAO objGolosinaDAO;
    GolosinaBean objGolosinaBean;
    ArrayList<GolosinaBean> lista;
    /**
     * Creates new form VentanaAseo
     */
    public VentanaGolosina() {
        initComponents();
        this.setLocationRelativeTo(null);
        objConsultarGolosina = new ConsultarGolosina();
        ...
        TablaGolosina.setModel(modelo);
        
        Listar();
        txtFiltrado(filtroMarca);
        trsFiltro=new TableRowSorter(modelo);
        TablaGolosina.setRowSorter(trsFiltro);
        
        objGolosinaDAO=new GolosinaDAO(this);
        
         Image icon = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Iconos/Golosina.png"));
        setIconImage(icon);
         setVisible(true);
    ...
    public void initComponents() {
        ...
        TablaGolosina = new javax.swing.JTable();
       ...
       ComboBoxSub.addItemListener(new java.awt.event.ItemListener() {
        ...
        TablaGolosina.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(TablaGolosina);
        ...
        iconcat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/Golosinas.png"))); // NOI18N
        jLabel2.add(iconcat);
        iconcat.setBounds(48, 23, 72, 72);
        
        Fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/FondoGolosina2.jpg"))); // NOI18N
        ...
        pack();
                ...
                ComboBoxSub.addItem(" ");
                ComboBoxSub.addItem("Caramelos");
                ComboBoxSub.addItem("Cereales");
                ComboBoxSub.addItem("Chocolates");
                ComboBoxSub.addItem("Galletas");
                ComboBoxSub.addItem("Snacks");
        
                TablaGolosina.addMouseListener(this);
    ...
    public void Listar(){
        try {
            objGolosinaDAO.Listar();
        }catch (Exception e){
        } 
    }
    
    public void borrarDato(){
        objGolosinaDAO.BorrarDato();
    }
    
    public void vaciarDato(){
        objGolosinaDAO.VaciarDato();
    }
    
    
    public void seleccionar(){
        try{
            objGolosinaDAO.Seleccionar();
        }catch (Exception e){}  
    }
    ...
    public void LimpiarCampos(){
        objGolosinaDAO.LimpiarCampos();
    }
    
    public void actualizarDatos(){
        objGolosinaDAO.ActualizarDatos();
    }
    ...
    public static void main(String args[]) throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
        ...
        try {
            ...
            new VentanaGolosina().setVisible(true);
    }
