...
import Modelo.FrutasBean;
import Modelo.ConsultarFrutas;
import Modelo.FrutasDAO;
import Modelo.RSButtonMetro;
import java.awt.Color;

public final class VentanaFrutas extends JFrame implements ActionListener,MouseListener, KeyListener {
    public JComboBox<String> ComboBoxSub;
    public JLabel Fondo;
    public JLabel Imagen;
    public JTable TablaFrutas;
    ...
    public VentanaFrutas() {
        ...
        objConsultarFrutas = new ConsultarFrutas();
        ...
        TablaFrutas.setRowSorter(trsFiltro);
        
        objFrutasDAO=new FrutasDAO(this);
        
         Image icon = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Iconos/Fruit.png"));
        setIconImage(icon);
         setVisible(true);
    ...
    public void initComponents() {
       ...
       ComboBoxSub.addItemListener(new java.awt.event.ItemListener() {
        ...
        jLabel3.setText("                                         Frutas y Verduras");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(250, 30, 660, 40);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/Banner1.png"))); // NOI18N
        jPanel1.add(jLabel2);
        jLabel2.setBounds(340, 0, 480, 110);
        
        iconcat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/frutas.png"))); // NOI18N
        jLabel2.add(iconcat);
        iconcat.setBounds(55, 20, 75, 75);
        
        Fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/FondoFrutas.jpg"))); // NOI18N
        ...
        pack();
                ...
                ComboBoxSub.addItem(" ");
                ComboBoxSub.addItem("Aceituna");
                ComboBoxSub.addItem("Almendra");
                ComboBoxSub.addItem("Banana");
                ComboBoxSub.addItem("Cacao");
                ComboBoxSub.addItem("Calabaza");
                ComboBoxSub.addItem("Chirimoya");
                ComboBoxSub.addItem("Durazno");
                ComboBoxSub.addItem("Granadilla");
                ComboBoxSub.addItem("Lima");
                ComboBoxSub.addItem("Lúcuma");
                ComboBoxSub.addItem("Maní");
                ComboBoxSub.addItem("Manzana");
                ComboBoxSub.addItem("Maracuya");
                ComboBoxSub.addItem("Melón");
                ComboBoxSub.addItem("Naranja");
                ComboBoxSub.addItem("Palta");
                ComboBoxSub.addItem("Pera");
                ComboBoxSub.addItem("Piña");
                ComboBoxSub.addItem("Sandía");
                ComboBoxSub.addItem("Tomate");
                TablaFrutas.addMouseListener(this);
    ...
    public void borrarDato(){
        objFrutasDAO.BorrarDato();
    }
    
    public void vaciarDato(){
        objFrutasDAO.VaciarDato();
    }
    
    
    public void seleccionar(){
        try{
            objFrutasDAO.Seleccionar();
        }catch (Exception e){}  
    }
    ...
    public void LimpiarCampos(){
        objFrutasDAO.LimpiarCampos();
    }
    
    public void actualizarDatos(){
        objFrutasDAO.ActualizarDatos();
    }
