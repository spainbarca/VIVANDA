...
import Modelo.LimpiezaBean;
import Modelo.ConsultarLimpieza;
import Modelo.LimpiezaDAO;
import Modelo.RSButtonMetro;
import java.awt.Color;

public final class VentanaLimpieza extends JFrame implements ActionListener,MouseListener, KeyListener {
    public JComboBox<String> ComboBoxSub;
    public JLabel Fondo;
    public JLabel Imagen;
    public JTable TablaLimpieza;
    ...
    public VentanaLimpieza() {
        ...
        objConsultarLimpieza = new ConsultarLimpieza();
        ...
        TablaLimpieza.setModel(modelo);
        
        Listar();
        txtFiltrado(filtroMarca);
        trsFiltro=new TableRowSorter(modelo);
        TablaLimpieza.setRowSorter(trsFiltro);
        
        objLimpiezaDAO=new LimpiezaDAO(this);
        
         Image icon = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Iconos/Limpieza.png"));
        setIconImage(icon);
         setVisible(true);
    ...
    public void initComponents() {
       ...
       ComboBoxSub.addItemListener(new java.awt.event.ItemListener() {
        ...
        jLabel3.setText("                                      Limpieza Doméstica");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(250, 30, 660, 40);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/Banner10.png"))); // NOI18N
        jPanel1.add(jLabel2);
        jLabel2.setBounds(340, 0, 480, 110);
        
        iconcat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/escoba.png"))); // NOI18N
        jLabel2.add(iconcat);
        iconcat.setBounds(50, 23, 75, 75);
        
        Fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/FondoLimpieza.jpg"))); // NOI18N
        ...
        pack();
                ...
                ComboBoxSub.addItem(" ");
                ComboBoxSub.addItem("Accesorios");
                ComboBoxSub.addItem("Ambientadores");
                ComboBoxSub.addItem("Desinfectantes");
                ComboBoxSub.addItem("Detergente");
                ComboBoxSub.addItem("Limpiadores");
        
                TablaLimpieza.addMouseListener(this);
    ...
    public void Listar(){
        try {
            objLimpiezaDAO.Listar();
        }catch (Exception e){
        } 
    }
    
    public void borrarDato(){
        objLimpiezaDAO.BorrarDato();
    }
    
    public void vaciarDato(){
        objLimpiezaDAO.VaciarDato();
    }
    
    
    public void seleccionar(){
        try{
            objLimpiezaDAO.Seleccionar();
        }catch (Exception e){}  
    }
    ...
    public void LimpiarCampos(){
        objLimpiezaDAO.LimpiarCampos();
    }
    
    public void actualizarDatos(){
        objLimpiezaDAO.ActualizarDatos();
    }
    ...
    public static void main(String args[]) throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
        ...
        try {
            ...
            new VentanaLimpieza().setVisible(true);
    }
