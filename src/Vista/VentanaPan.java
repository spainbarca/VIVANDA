...
import Modelo.PanBean;
import Modelo.ConsultarPan;
import Modelo.PanDAO;
import Modelo.RSButtonMetro;
import java.awt.Color;

public final class VentanaPan extends JFrame implements ActionListener,MouseListener, KeyListener {
    public JComboBox<String> ComboBoxSub;
    public JLabel Fondo;
    public JLabel Imagen;
    public JTable TablaPan;
    ...
    public VentanaPan() {
        ...
        objConsultarPan = new ConsultarPan();
        ...
        TablaPan.setModel(modelo);
        
        Listar();
        txtFiltrado(filtroMarca);
        trsFiltro=new TableRowSorter(modelo);
        TablaPan.setRowSorter(trsFiltro);
        
        objPanDAO=new PanDAO(this);
        
         Image icon = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Iconos/Pan.png"));
        setIconImage(icon);
         setVisible(true);
    ...
    public void initComponents() {
       ...
       ComboBoxSub.addItemListener(new java.awt.event.ItemListener() {
        ...
        jScrollPane1.setViewportView(TablaPan);
        ...
        jLabel3.setText("                                     Panadería y Pastelería");
        jPanel1.add(jLabel3);
        ...
        iconcat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/panaderia.png"))); // NOI18N
        jLabel2.add(iconcat);
        iconcat.setBounds(35, 19, 97, 75);
        
        Fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/FondoPan.jpg"))); // NOI18N
        ...
        pack();
                ...
                ComboBoxSub.addItem(" ");
                ComboBoxSub.addItem("Dulces");
                ComboBoxSub.addItem("Masas");
                ComboBoxSub.addItem("Panes");
                ComboBoxSub.addItem("Panetones");
                ComboBoxSub.addItem("Pasteles");
                ComboBoxSub.addItem("Turrones");
        
                TablaPan.addMouseListener(this);
    ...
    public void borrarDato(){
        objPanDAO.BorrarDato();
    }
    
    public void vaciarDato(){
        objPanDAO.VaciarDato();
    }
    
    
    public void seleccionar(){
        try{
            objPanDAO.Seleccionar();
        }catch (Exception e){}  
    }
    ...
    public void LimpiarCampos(){
        objPanDAO.LimpiarCampos();
    }
    
    public void actualizarDatos(){
        objPanDAO.ActualizarDatos();
    }
